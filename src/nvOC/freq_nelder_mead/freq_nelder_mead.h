...
namespace frequency_scaling {
    ...
    measurement freq_nelder_mead(currency_type ct, const device_clock_info &dci, int min_iterations, int max_iterations,
                                 int mem_step, int graph_idx_step, double min_hashrate = -1.0,
                                 double mem_scale = 1.5, double graph_scale = 2.5);
